var str = "JS 코드는 함수가 아닌 JS 파일 또는 script 태그 내부에 바로 작성하면" 
            + "HTML 랜더링 시 바로 수행된다.";
...
// console.log("함수 외부 num3 : " + num3); //Uncaught ReferenceError: num3 is not defined
// 함수 종료 후에는 사용 불가 -> 지역변수
...
function typeTest(){
    ...
    // console.log(temp3); //Uncaught ReferenceError: temp3 is not defined
